...
def make_epsilon_greedy_policy(Q, G, epsilon, observation, deadline):
    ...
    time_traversed = int(np.random.uniform(0, G[int(current_node)][int(next_edge)]["wc"],1))
...
print("Network with Uniform distribution worst case. deadline ",deadline," with epsiodes", num_episodes)
